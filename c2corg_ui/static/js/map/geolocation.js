...
app.geolocationDirective = function() {
  return {
    ...
    template:
      '<button ngeo-mobile-geolocation translate ' +
        'ngeo-mobile-geolocation-map="::geoCtrl.map" ' +
        'ngeo-mobile-geolocation-options="::geoCtrl.mobileGeolocationOptions">Recenter on my position' +
      '</button>'
  };
};
